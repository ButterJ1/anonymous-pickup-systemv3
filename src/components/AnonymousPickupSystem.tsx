...
import { usePickupSystem } from '../hooks/usePickupSystem';

// const usePickupSystem = () => {
//   // This is a simplified version - replace with actual hook from usePickupSystem.ts
...
//     setLoading(true);
//     try {
//       // EIP-7702 delegation would happen here
//       await new Promise(resolve => setTimeout(resolve, 3000));
      
//       // Generate commitments using ZKUtils
...
//       setUserIdentity({ name, phone, age: age.toString(), secret: '_secret', nameHash: '_hash', phoneLastThree: phone.slice(-3), nonce: '_nonce' });
                ...
                <div className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                      EIP-7702 delegation for anonymous pickups
                    </p>
                  </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700 dark:text-blue-400">
                            Your data is processed locally with cryptographic commitments. 
              ...
              {currentPhase === 1 && (
                <div className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                      Register package with seller commitment generation
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className={`${darkMode ? 'bg-green-900/20 border-green-700' : 'bg-green-50 border-green-200'} border rounded-xl p-4`}>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h3 className="font-medium text-green-800 dark:text-green-300 mb-1">Seller Commitment</h3>
              ...
              {currentPhase === 2 && (
                <div className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                      Three-party anonymous verification
                    </p>
                  </div>
                      ...
                      <div className={`${darkMode ? 'bg-purple-900/20 border-purple-700' : 'bg-purple-50 border-purple-200'} border rounded-xl p-6`}>
                        ...
                        <div className="text-center py-8">
                          ...
                          <p className="text-sm text-purple-700 dark:text-purple-400">
                            QR contains seller commitment: {packageData.sellerCommitment?.slice(0, 10)}...
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-6">
                      <div className={`${darkMode ? 'bg-green-900/20 border-green-700' : 'bg-green-50 border-green-200'} border rounded-xl p-6`}>
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <h3 className="font-semibold text-green-800 dark:text-green-300">ZK Proof Generated</h3>
                        </div>
              ...
              {currentPhase === 3 && (
                <div className="p-8 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-lg mb-8">
                    Package successfully collected with cryptographic privacy
                  </p>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 text-sm">
                    <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg p-4`}>
                      <h4 className="font-semibold mb-2">EIP-7702</h4>
                      <p className="text-gray-600 dark:text-gray-400">Smart EOA delegation executed</p>
                    </div>
                    <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg p-4`}>
                      <h4 className="font-semibold mb-2">ZK Proof</h4>
          ...
          <div className="space-y-6">
            ...
            <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-lg border p-6`}>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" />
                  <span>Group signature proofs</span>
                </div>
              </div>
            </div>
          </div>
